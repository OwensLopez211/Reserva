    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('owner', 'Propietario'), ('admin', 'Administrador'), ('staff', 'Personal'), ('professional', 'Profesional'), ('reception', 'Recepción')], default='staff', max_length=20)),
